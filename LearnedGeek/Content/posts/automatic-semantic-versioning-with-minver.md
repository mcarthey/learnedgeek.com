...
- [CI/CD Version Verification](/Blog/Post/cicd-version-verification) — How to verify those MinVer versions actually deployed
- [Tracer Bullet Development: Prove Your Pipeline First](/Blog/Post/tracer-bullet-development-prove-your-pipeline) — How I validated this CI/CD architecture
- [Environment-Specific EF Core Migrations](/Blog/Post/environment-specific-ef-core-migrations) — Another pattern for environment-aware builds
